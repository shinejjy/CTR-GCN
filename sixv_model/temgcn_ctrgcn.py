...
class Temporal_GCN(nn.Module):
    def __init__(self, in_channel, rel_channel=4, n_head=4):
    ...
    def forward(self, x):
        ...
        for i in range(self.n_head):
            z = torch.einsum('btg,bctv->bcgv', multi_At[i], x)
            z = self.fcs[i](z)
...
class Stage2(nn.Module):
    def __init__(self, num_class=60, num_point=25, num_person=2, graph=None, in_channels=3,
        ...
        self.tem_gcn_bottom = Temporal_GCN(base_channel, rel_channel=4, n_head=4)
        ...
        self.tem_gcn_middle = Temporal_GCN(base_channel * 2, rel_channel=4, n_head=4)
        ...
        self.tem_gcn_top = Temporal_GCN(base_channel * 4, rel_channel=4, n_head=4)
