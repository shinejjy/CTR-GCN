...
class Stage2(nn.Module):
    ...
    def forward(self, x):
        ...
        x = self.l1(x)  # (N*M, 64, 64, 25)
        x = self.l2(x)  # (N*M, 64, 64, 25)
        x = self.l3(x)  # (N*M, 64, 64, 25)
        x = self.l4(x)  # (N*M, 64, 64, 25)
        x2 = x
        x = self.l5(x)  # (N*M, 128, 32, 25)
        x = self.l6(x)  # (N*M, 128, 32, 25)
        x = self.l7(x)  # (N*M, 128, 32, 25)
        x3 = x
        x = self.l8(x)  # (N*M, 256, 16, 25)
        x = self.l9(x)  # (N*M, 256, 16, 25)
        x = self.l10(x)  # (N*M, 256, 16, 25)
